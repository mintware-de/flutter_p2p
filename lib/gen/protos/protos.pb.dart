...
class StateChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('StateChange', createEmptyInstance: create)
  ...
  StateChange copyWith(void Function(StateChange) updates) => super.copyWith((message) => updates(message as StateChange));
...
class WifiP2pDevice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WifiP2pDevice', createEmptyInstance: create)
    ...
    ..e<WifiP2pDevice_Status>(10, 'status', $pb.PbFieldType.OE, defaultOrMaker: WifiP2pDevice_Status.CONNECTED, valueOf: WifiP2pDevice_Status.valueOf, enumValues: WifiP2pDevice_Status.values)
    ..hasRequiredFields = false
  ;
  ...
  WifiP2pDevice copyWith(void Function(WifiP2pDevice) updates) => super.copyWith((message) => updates(message as WifiP2pDevice));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WifiP2pDeviceList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WifiP2pDeviceList', createEmptyInstance: create)
    ..pc<WifiP2pDevice>(1, 'devices', $pb.PbFieldType.PM, subBuilder: WifiP2pDevice.create)
    ..hasRequiredFields = false
  ;
  ...
  WifiP2pDeviceList copyWith(void Function(WifiP2pDeviceList) updates) => super.copyWith((message) => updates(message as WifiP2pDeviceList));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConnectionChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ConnectionChange', createEmptyInstance: create)
    ..aOM<WifiP2pInfo>(1, 'wifiP2pInfo', protoName: 'wifiP2pInfo', subBuilder: WifiP2pInfo.create)
    ..aOM<NetworkInfo>(2, 'networkInfo', protoName: 'networkInfo', subBuilder: NetworkInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  ConnectionChange copyWith(void Function(ConnectionChange) updates) => super.copyWith((message) => updates(message as ConnectionChange));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WifiP2pInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('WifiP2pInfo', createEmptyInstance: create)
  ...
  WifiP2pInfo copyWith(void Function(WifiP2pInfo) updates) => super.copyWith((message) => updates(message as WifiP2pInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NetworkInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('NetworkInfo', createEmptyInstance: create)
    ..a<$core.int>(1, 'subType', $pb.PbFieldType.O3, protoName: 'subType')
    ..aOB(2, 'isConnected', protoName: 'isConnected')
    ..e<NetworkInfo_DetailedState>(3, 'detailedState', $pb.PbFieldType.OE, protoName: 'detailedState', defaultOrMaker: NetworkInfo_DetailedState.IDLE, valueOf: NetworkInfo_DetailedState.valueOf, enumValues: NetworkInfo_DetailedState.values)
  ...
  NetworkInfo copyWith(void Function(NetworkInfo) updates) => super.copyWith((message) => updates(message as NetworkInfo));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RequestPermissionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RequestPermissionResult', createEmptyInstance: create)
    ..a<$core.int>(1, 'requestCode', $pb.PbFieldType.O3, protoName: 'requestCode')
  ...
  RequestPermissionResult copyWith(void Function(RequestPermissionResult) updates) => super.copyWith((message) => updates(message as RequestPermissionResult));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SocketMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SocketMessage', createEmptyInstance: create)
    ..a<$core.int>(1, 'port', $pb.PbFieldType.O3)
    ..a<$core.int>(2, 'dataAvailable', $pb.PbFieldType.O3, protoName: 'dataAvailable')
